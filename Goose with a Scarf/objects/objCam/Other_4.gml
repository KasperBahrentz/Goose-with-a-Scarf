...
// Mountains front
layer_x("mountains_front", random_div8_range(-2 * tile_size, 8 * tile_size));
layer_y("mountains_front", layer_get_y("mountains_front") + random_div8_range(-3 * tile_size, 0));

// Mountains middle
layer_x("mountains_middle", random_div8_range(-2 * tile_size, 8 * tile_size));
layer_y("mountains_middle", layer_get_y("mountains_front") + random_div8_range(-2 * tile_size, 0));

// Mountains back
layer_x("mountains_back", random_div8_range(-2 * tile_size, 8 * tile_size));
...
if (tileset_name == "tlsGroundWinter"){
	...
	repeat(random_range(40, 50)) instance_create_layer(random_div8_range(0, room_width), random_div8_range(3*tile_size, room_height-room_height/3), _stars, objStar);
}
