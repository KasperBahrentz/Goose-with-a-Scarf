...
layer_y("mountains_front", (room_height - sprite_get_height(sprSummerMountainsFront)) + random_range(-4*tile_size, 2*tile_size));

layer_x("mountains_middle", random_range(-2*tile_size, 8*tile_size));
layer_y("mountains_middle", (room_height - sprite_get_height(sprSummerMountainsFront)) + random_range(-3*tile_size, 2*tile_size));

layer_x("mountains_back", random_range(-2*tile_size, 8*tile_size));
layer_y("mountains_back", (room_height - sprite_get_height(sprSummerMountainsFront)) + random_range(-2*tile_size, 2*tile_size));
