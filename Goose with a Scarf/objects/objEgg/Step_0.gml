switch (state){
	...
	case egg_state.FLY: fly(); break;	
}


function move(){
	if (array_length(objGooseBody.follow_queue) == 1){
		state = egg_state.IDLE;
	}
	
	var _min_distance = 0 * objGame.pixel_size; // Set the stopping distance
	...
	// TO-DO: MOVE THIS TO IDLE FUNCTION
